  ...
  List<CommentModel> getComment() {
    return <CommentModel>[
      CommentModel(
          ...
          content: 'abc',
          isRoot: true,
          createdAt: DateTime(2020, 1, 1, 0, 1).millisecond,
          comments: <CommentModel>[
            CommentModel(
                ...
                content: 'abc',
                isRoot: false,
                createdAt: DateTime(2020, 1, 1, 0, 2).millisecond,
                comments: <CommentModel>[
                  CommentModel(
                      id: 011,
                      userId: 3,
                      ...
                      content: 'abc',
                      isRoot: false,
                      createdAt: DateTime(2020, 1, 1, 0, 4).millisecond,
                      comments: <CommentModel>[],
                      expanded: false,
                      parentPositions: [0, 0]),
                  CommentModel(
                      ...
                      content: 'abc',
                      isRoot: false,
                      createdAt: DateTime(2020, 1, 1, 0, 3).millisecond,
                      comments: <CommentModel>[],
                      expanded: false,
                      parentPositions: [0, 0]),
                ],
